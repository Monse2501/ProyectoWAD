            ...
            <div class="container">
                ...
                <nav class="top-nav">
                    <ul class="top-nav">
                        ...
                        <li><a href="#about" class="scroll">Sucursales</a></li>
                        <li><a href="#services" class="scroll">Managers</a></li>
                        <li><a href="#portfolio" class="scroll">Reportes</a></li>
                        <li><a href="#contact" class="scroll">Gráficas</a></li>
                        <li><a href="#contact" class="scroll">Configuración</a></li>
                        <li><a href="#contact" class="scroll">Cerrar sesión</a></li>
                    </ul>
