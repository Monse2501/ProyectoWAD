<%-- 
    Document   : Plantilla
    Created on : 6/01/2016, 12:06:34 AM
    Author     : Max
--%>
                ...
                <div class="sap_tabs">
                    <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                        <ul class="resp-tabs-list">
                            ...
                            <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Photography</span></li>
                            <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Web design</span></li>
                            <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span>Graphics</span></li>
                            <div class="clearfix"> </div>
                        </ul>	
                        <div class="resp-tabs-container">
                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                <div class="tab_img">
                                    <div class="col-md-3 img-top ">
                                        <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                                            ...
                                            <div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><div class="caption1">
                                    ...
                                    <div class="col-md-3 img-top ">
                                        <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                                            <img src="images/pic-4.png" class="img-responsive" alt=""/>
                                            <div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 ">
                                                    <div class="caption1">
                                                        <img src="images/Bfly.png" alt="" />
                                                        <p>This is Photoshop's version  of Lorem Ipsum..</p>
                                ...
                                <div class="tab_img">
                                    ...
                                    <div class="col-md-3 img-top ">
                                        <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                                            <img src="images/pic-8.png" class="img-responsive" alt=""/>
                                            <div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 ">
                                                    <div class="caption1">
                                                        <img src="images/Bfly.png" alt="" />
                                                        <p>This is Photoshop's version  of Lorem Ipsum..</p>
                ...
                <div class="col-md-4 footer-grid footer-grid1">
                    <div class="f-bout">
                        ...
                        <img src="images/footer-pic.png" alt"" />
                             <h5>Mail Us</h5>
                        <h6><a href="mailto:@example.com">info@w3layouts.com</a></h6>
                    </div>
                </div>
        ...
        <div class="bottom">
            <div class="container">
                <div class="copy-right">
                    <p>Copyright &copy; 2014 Papiyon . All Rights Reserved . Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
                </div>								
                <div class="clearfix"> </div>
                <script type="text/javascript">
                    $(document).ready(function () {
